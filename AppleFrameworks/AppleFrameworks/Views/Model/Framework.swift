...
struct MockData {
    ...
    static let sampleFramework = frameworks.last!
    
    static let frameworks = [
        Framework(name: "App Clips",
                  imageName: "app-clip",
                  urlString: URL(string: "https://developer.apple.com/app-clips")!,
        ...
        Framework(name: "ARKit",
                  imageName: "arkit",
                  urlString: URL(string: "https://developer.apple.com/augmented-reality/arkit")!,
        ...
        Framework(name: "CarPlay",
                  imageName: "carplay",
                  urlString: URL(string: "https://developer.apple.com/carplay")!,
        ...
        Framework(name: "Catalyst",
                  imageName: "catalyst",
                  urlString: URL(string: "https://developer.apple.com/mac-catalyst")!,
        ...
        Framework(name: "ClassKit",
                  imageName: "classkit",
                  urlString: URL(string: "https://developer.apple.com/classkit")!,
        ...
        Framework(name: "CloudKit",
                  imageName: "cloudkit",
                  urlString: URL(string: "https://developer.apple.com/icloud/cloudkit")!,
        ...
        Framework(name: "Core ML",
                  imageName: "coreml",
                  urlString: URL(string: "https://developer.apple.com/machine-learning")!,
        ...
        Framework(name: "HealthKit",
                  imageName: "healthkit",
                  urlString: URL(string: "https://developer.apple.com/health-fitness")!,
        ...
        Framework(name: "Metal",
                  imageName: "metal",
                  urlString: URL(string: "https://developer.apple.com/metal")!,
        ...
        Framework(name: "SF Symbols",
                  ...
                  urlString: URL(string: "https://developer.apple.com/sf-symbols")!,
        ...
        Framework(name: "SiriKit",
                  imageName: "sirikit",
                  urlString: URL(string: "https://developer.apple.com/siri")!,
        ...
        Framework(name: "SpriteKit",
                  imageName: "spritekit",
                  urlString: URL(string: "https://developer.apple.com/spritekit")!,
        ...
        Framework(name: "SwiftUI",
                  imageName: "swiftui",
                  urlString: URL(string: "https://developer.apple.com/xcode/swiftui")!,
        ...
        Framework(name: "Test Flight",
                  ...
                  urlString: URL(string: "https://developer.apple.com/testflight")!,
        ...
        Framework(name: "Wallet",
                  imageName: "wallet",
                  urlString: URL(string: "https://developer.apple.com/wallet/get-started")!,
        ...
        Framework(name: "WidgetKit",
                  imageName: "widgetkit",
                  urlString: URL(string: "https://developer.apple.com/widgets")!,
